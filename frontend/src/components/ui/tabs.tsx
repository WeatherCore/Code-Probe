...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ref={ref}
    className={cn(
      "inline-flex items-center justify-center gap-1.5 whitespace-nowrap rounded-md px-3 py-1 text-sm font-medium text-foreground-muted transition-all",
      "hover:text-foreground",
      "data-[state=active]:bg-surface-hover data-[state=active]:text-foreground data-[state=active]:shadow-sm",
